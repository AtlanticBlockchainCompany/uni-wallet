...
module.exports = function(options) {
    ...
    if (options.prod) {
        ...
        plugins.push(new CopyWebpackPlugin([
            ...
            { from: path.resolve(root_dir, "app/assets/createjs-2015.11.26.min.js"), to: path.resolve(outputPath, "createjs-2015.11.26.min.js") },
        ]));
    } else {
    ...
    var config = {
        ...
        module: {
            ...
            loaders: [
                ...
                { test: /.*\.svg$/, loaders: ["svg-inline-loader", "svgo-loader"] , exclude:[path.resolve(root_dir, "app/assets/images/games/rps")]},
